    ...
    <div className="min-h-screen bg-surface-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-surface-200 text-sm">Sign in to your account</p>
        </div>
        ...
        <div className="card p-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-brand-500 hover:text-brand-400">Forgot?</Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-surface-200 text-sm mt-5">
            No account?{' '}
            <Link href="/auth/signup" className="text-brand-500 font-semibold hover:text-brand-400">
              Create one free
            </Link>
          </p>
        </div>
